...
function showQuestions(question: { question: string; image: any; answers: any[] }) {
    ...
    question.answers.forEach( (answer: { text: string; correct: string | undefined }) => {
...
function setStatus (element: Element, correct: any) {
    clearStatus(element)
    if (correct) {
...
function clearStatus (element: { classList: { remove: (arg0: string) => void } }) {
